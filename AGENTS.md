...
Add narrow project-specific rules below this section or in scoped nested instruction files. Keep them concise, evidence-based, testable, and non-duplicative.
